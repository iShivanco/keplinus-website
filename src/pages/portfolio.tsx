...
export default function Portfolio() {
  return (
    <>
      {/* ===== SEO HEAD ===== */}
      <Head>
        <title>Keplinus Portfolio – Featured Projects & Case Studies</title>
        <meta
          name="description"
          content="Explore Keplinus' portfolio of innovative web and AI projects, including AI credit scoring, dashboards, mobile apps, and more. See our featured work."
        />
        <link rel="canonical" href="https://keplinus.vercel.app/portfolio" />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="Keplinus Portfolio – Featured Projects"
        />
        <meta
          property="og:description"
          content="Check out Keplinus' innovative AI and web projects. Discover our AI credit scoring system, dashboards, mobile apps, and more."
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://keplinus.vercel.app/portfolio"
        />
        <meta
          property="og:image"
        ...
        <meta
          ...
          content="Explore Keplinus' innovative AI and web projects, from credit scoring models to mobile apps and dashboards."
        />
        <meta
          name="twitter:image"
          content="https://keplinus.vercel.app/logo-og.png"
